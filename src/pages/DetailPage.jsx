...
import { Play, Video, Plus, Check, Heart, Star, ArrowLeft, Layers } from 'lucide-react';
...
export default function DetailPage() {
  ...
  const { openPlayer, openTrailer, toggleWatchlist, isSaved, toggleFavorite, isFavorite, getRating, setRating } = useStore();

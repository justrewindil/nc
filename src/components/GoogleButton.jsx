...
const GoogleIcon = () => (
  <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden>
    ...
    <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4.1 5.5l6.5 5.5C39.9 36.8 44 31 44 24c0-1.3-.1-2.3-.4-3.5z" />
  </svg>
);
...
export default function GoogleButton({ label = 'Continue with Google' }) {
  ...
  const onClick = async () => {
    ...
    if (error) setBusy(false); // on success the page redirects to Google
  };
  return (
